...
and the amount is chosen. **direction, calibrated**: the amount was fitted to reference photos
of the look (`tools/calibrate_recipe.py`), keeping the tutorial's sign; 0 means the references
do not support that step. **conflict**: the tutorials disagree (the note says which was followed).

## fujifilm

Calibrated against 46 openly licensed Fuji film scans (Superia, C200, Pro 400H...).

| tool | setting | value | source | kind | what the tutorial says |
|---|---|---|---|---|---|
...
The 36 neon-street references were used to choose and check the look.
